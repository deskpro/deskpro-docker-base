...
# Set defaults
export FPM_USER=${FPM_USER:-"php"}
export FPM_GROUP=${FPM_GROUP:-"php"}
...
envsubst '$FPM_USER $FPM_GROUP $FPM_MAX_CHILDREN $FPM_START_SERVERS $FPM_MIN_SPARE_SERVERS $FPM_MAX_SPARE_SERVERS $FPM_PROCESS_IDLE_TIMEOUT $FPM_MAX_REQUESTS' \
